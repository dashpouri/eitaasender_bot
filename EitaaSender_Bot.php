 ...
 */
    ...
    function save_file() {
      if ($message_file_size < 21000000) { //20 MB
        ...
        // خطا
        else if($message_file_size > 21000000) {  // 20 MB
    ...
    // ذخیره موسیقی
    function save_audio() {
      if ($GLOBALS['message_audio_size'] < 21000000) {
        $update_array = $GLOBALS['update_array'];
      ...
      // خطا
      else if($GLOBALS['message_audio_size'] > 21000000) {  // 20 MB
    ...
    // ذخیره پیام صوتی
    function save_voice() {
      if ($GLOBALS['message_voice_size'] < 21000000) {
        $update_array = $GLOBALS['update_array'];
      ...
      // خطا
      else if($GLOBALS['message_voice_size'] > 21000000) {  // 20 MB
    ...
    // ذخیره ویدیو
    function save_video() {
      if ($GLOBALS['message_video_size'] < 21000000) {
        $update_array = $GLOBALS['update_array'];
      ...
      // خطا
      else if($GLOBALS['message_video_size'] > 21000000) {  // 20 MB
